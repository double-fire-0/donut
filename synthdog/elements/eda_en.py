...
#cleaning up text
import re
def get_only_chars_number(line):
...
########################################################################
# Random insertion numbers
# Randomly insert n numbers into the sentence
########################################################################
...
def eda_en(sentence, alpha_sr=0.2, alpha_ri=0.2, alpha_rs=0.2, alpha_rd=0.2, alpha_rin=0.025, p_sr=0.24, p_ri=0.24, p_rs=0.24, p_rd=0.24, p_rin=0.01, num_aug=1):
    
    sentence = get_only_chars_number(sentence)
    ...
    weight = [p_sr, p_ri, p_rs, p_rd, p_rin]
    aug_list = ['sr', 'ri', 'rs', 'rd', 'rin']
    ...
    augmented_sentences = [get_only_chars_number(sentence) for sentence in augmented_sentences]
